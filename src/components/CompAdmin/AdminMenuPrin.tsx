...
export const AdminMenuPrin = () => {
  ...
  // Obtenemos los últimos 10 invertidos (los más nuevos primero)
  ...
  // Asumimos que 'Usuarios' son todos, o podrías restar los admins si prefieres
  const totalUsuarios = usuarios.length; 

  return (
     <div className="fade-in">
        
        {/* 1. TARJETAS DE RESUMEN (Compactas) */}
        ...
        {/* 2. LISTAS DE ÚLTIMOS MOVIMIENTOS */}
        <div className="row g-4">
            
            {/* COLUMNA IZQUIERDA: ÚLTIMOS PRODUCTOS */}
            <div className="col-xl-6 col-12">
                <div className="card border-secondary shadow-sm h-100">
                    <div className="card-header bg-white py-2 border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <span className="badge bg-light text-dark border">Activos</span>
                    </div>
            ...
            {/* COLUMNA DERECHA: ÚLTIMOS USUARIOS */}
            <div className="col-xl-6 col-12">
                <div className="card border-secondary shadow-sm h-100">
                    <div className="card-header bg-white py-2 border-bottom d-flex justify-content-between align-items-center">
                        <h6 className="tSec mb-0 text-dark fw-bold">
                                            ...
                                            <tr key={u.id}>
                                                ...
                                                <td>
                                                    {u.tipoUsuario === 'Admin' ? (
                                                        ...
                                                        <span className="badge bg-light text-dark border" style={{fontSize: '0.7rem'}}>User</span>
                                                    )}
                                                </td>
                                                <td className="text-end pe-3">
