...
export const Comunidad = () => {
  return (
    <>
      <main>
        <div id="tComunidad" className="cuadroComunidad divPrin p-5 my-5">
        ...
        <div className="container p-4 contenedorComunidad">

          <div id="tCont" className="cuadroComunidad divSec p-3 container mb-4">
