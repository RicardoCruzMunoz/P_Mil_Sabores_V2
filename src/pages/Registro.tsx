                        ...
                        <div className="card-body p-4">
                            ...
                            <form id="formRegistro" noValidate>
                                <div className="mb-3">
                                    ...
                                    <input id="nombre" className="form-control" type="text" maxLength={80} placeholder="Ejemplo: Nicolas Perez" required/>
                                ...
                                <div className="row my-3">
                                    ...
                                    <div className="container d-flex justify-content-center gap-2 mt-4">
                                        <a href="acceso.html" className="btnAcc btn btn-dark">Ir al login</a>
